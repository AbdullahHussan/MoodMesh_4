...
def send_emergency_email(user_id: str, crisis_context: str, severity: str, ai_message: str):
    """
    Send emergency alert email silently in background
    Hidden from user for safety - prevents blocking help during crisis
    """
    try:
        subject = f"🚨 URGENT: Mental Health Crisis Alert - {severity.upper()} Priority"
...
EMERGENCY CONTACTS TO REACH:
• 988 Suicide & Crisis Lifeline: Call or text 988
• Crisis Text Line: Text HOME to 741741
• International Association for Suicide Prevention: https://www.iasp.info/resources/Crisis_Centres/

This alert was automatically generated by the AI Mental Health Companion system.
Please take immediate action if this person is known to you.
...
EXERCISE_LIBRARY = [
    # STRENGTH EXERCISES
    {
        ...
        "form_tips": [
            ...
            "Lower your chest to within a few inches of the floor",
            "Keep your core engaged throughout",
            "Don't let your hips sag or pike up",
            "Look slightly ahead, not straight down"
        ],
        "key_points": ["shoulders", "elbows", "wrists", "hips", "knees"],
        "pose_requirements": {
            "elbow_angle_down": [70, 110],
            "elbow_angle_up": [160, 180],
    ...
    },
    {
        "id": "squats",
        "name": "Squats",
        "description": "Fundamental lower body exercise that works your quads, hamstrings, and glutes.",
        "category": "strength",
        "difficulty": "beginner",
        ...
        "key_points": ["hips", "knees", "ankles", "shoulders"],
        "pose_requirements": {
            "knee_angle_down": [70, 110],
            "knee_angle_up": [160, 180],
    ...
    },
    {
        ...
        "thumbnail_url": "https://img.youtube.com/vi/QOVaHwm-Q6U/maxresdefault.jpg",
        "duration_per_rep": 3,
    ...
    },
    {
        ...
        "thumbnail_url": "https://img.youtube.com/vi/pSHjTRCQxIw/maxresdefault.jpg",
        "duration_per_rep": 30,
        "calories_per_rep": 3.0,
        "form_tips": [
        ...
        "key_points": ["shoulders", "hips", "knees", "ankles"],
        "pose_requirements": {
            "body_alignment": "straight",
            "hip_height": "mid",
            "shoulder_over_elbow": True
        }
    },
    ...
    # CARDIO EXERCISES
    {
        ...
        "category": "cardio",
        "difficulty": "beginner",
        "target_muscles": ["legs", "shoulders", "core", "cardiovascular"],
        "video_url": "https://www.youtube.com/embed/iSSAk4XCsRA",
        "thumbnail_url": "https://img.youtube.com/vi/iSSAk4XCsRA/maxresdefault.jpg",
        "duration_per_rep": 1,
        ...
        "key_points": ["shoulders", "wrists", "hips", "ankles"],
        "pose_requirements": {
            "arms_up_angle": [160, 180],
            "legs_apart_width": "wide",
            "rhythm": "steady"
        }
    },
    {
        "id": "high-knees",
        "name": "High Knees",
        "description": "High-intensity cardio exercise that improves coordination and leg strength.",
        "category": "cardio",
        "difficulty": "intermediate",
        "target_muscles": ["quadriceps", "hip flexors", "core", "cardiovascular"],
        "video_url": "https://www.youtube.com/embed/8opcQdC-V-U",
        "thumbnail_url": "https://img.youtube.com/vi/8opcQdC-V-U/maxresdefault.jpg",
        "duration_per_rep": 1,
    ...
    },
    {
        ...
        "description": "Dynamic full-body exercise combining cardio with core strength.",
        "category": "cardio",
        "difficulty": "intermediate",
        "target_muscles": ["core", "shoulders", "legs", "cardiovascular"],
        "video_url": "https://www.youtube.com/embed/nmwgirgXLYM",
        "thumbnail_url": "https://img.youtube.com/vi/nmwgirgXLYM/maxresdefault.jpg",
        "duration_per_rep": 1,
        "calories_per_rep": 0.5,
        "form_tips": [
        ...
        "key_points": ["shoulders", "hips", "knees"],
        "pose_requirements": {
            "plank_position": True,
            "knee_drive_forward": True,
            "alternate_legs": True
        }
    },
    {
        "id": "burpees",
        "name": "Burpees",
        "description": "Full-body explosive exercise that combines cardio and strength.",
        "category": "cardio",
        "difficulty": "advanced",
        "target_muscles": ["full body", "cardiovascular"],
        "video_url": "https://www.youtube.com/embed/auBLPXO8Fww",
        "thumbnail_url": "https://img.youtube.com/vi/auBLPXO8Fww/maxresdefault.jpg",
        "duration_per_rep": 5,
    ...
    # YOGA POSES
    {
        ...
        "video_url": "https://www.youtube.com/embed/LsSB3fB8bTU",
        "thumbnail_url": "https://img.youtube.com/vi/LsSB3fB8bTU/maxresdefault.jpg",
        "duration_per_rep": 30,
        ...
        "key_points": ["shoulders", "hips", "knees", "ankles", "wrists"],
        "pose_requirements": {
            "hip_angle": [40, 80],
            "arm_straight": True,
    ...
    },
    {
        "id": "warrior-pose",
        "name": "Warrior I Pose",
        "description": "Powerful standing yoga pose that builds strength and stability.",
        "category": "yoga",
        "difficulty": "beginner",
        "target_muscles": ["legs", "glutes", "core", "shoulders"],
        "video_url": "https://www.youtube.com/embed/VJ4YV-ccXNo",
        "thumbnail_url": "https://img.youtube.com/vi/VJ4YV-ccXNo/maxresdefault.jpg",
        "duration_per_rep": 30,
        "calories_per_rep": 2.0,
        "form_tips": [
            "Step one foot back in a lunge position",
    ...
    },
    {
        "id": "tree-pose",
        "name": "Tree Pose",
        "description": "Balancing yoga pose that improves focus and strengthens legs.",
        "category": "yoga",
        "difficulty": "intermediate",
        "target_muscles": ["legs", "core", "balance"],
        "video_url": "https://www.youtube.com/embed/vN5A9to_PoE",
        "thumbnail_url": "https://img.youtube.com/vi/vN5A9to_PoE/maxresdefault.jpg",
        "duration_per_rep": 30,
        "calories_per_rep": 1.0,
        "form_tips": [
            "Stand on one leg",
    ...
    },
    {
        ...
        "description": "Strengthening yoga pose that works the legs and core.",
        "category": "yoga",
        "difficulty": "beginner",
        "target_muscles": ["quadriceps", "glutes", "core", "shoulders"],
        "video_url": "https://www.youtube.com/embed/PTP2W7MnKfg",
        "thumbnail_url": "https://img.youtube.com/vi/PTP2W7MnKfg/maxresdefault.jpg",
        "duration_per_rep": 30,
        "calories_per_rep": 2.0,
        "form_tips": [
            "Stand with feet together",
            "Bend knees and sit back as if in a chair",
            "Raise arms overhead",
        ...
        "pose_requirements": {
            "knee_angle": [70, 110],
            "arms_overhead": True,
            "torso_forward_lean": "slight",
            "weight_in_heels": True
        }
    }
]


@api_router.get("/exercises/list")
async def get_exercise_list(category: Optional[str] = None, difficulty: Optional[str] = None):
    """Get list of all available exercises with optional filtering"""
    try:
        ...
        logging.error(f"Error fetching exercise list: {str(e)}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_exercise_details(exercise_id: str):
    ...
    try:
        exercise = next((ex for ex in EXERCISE_LIBRARY if ex['id'] == exercise_id), None)
        if not exercise:
        ...
        logging.error(f"Error fetching exercise details: {str(e)}")
        raise HTTPException(status_code=500, detail=str(e))


@api_router.post("/exercises/session/start")
async def start_exercise_session(session_data: ExerciseSessionStart):
    """Start a new exercise session"""
    try:
        # Get exercise details
        exercise = next((ex for ex in EXERCISE_LIBRARY if ex['id'] == session_data.exercise_id), None)
        if not exercise:
            raise HTTPException(status_code=404, detail="Exercise not found")
        ...
        session = ExerciseSession(
            ...
            used_ai_coach=session_data.used_ai_coach
        )
        
        # Save to database
        doc = session.model_dump()
        doc['session_start'] = doc['session_start'].isoformat()
        await db.exercise_sessions.insert_one(doc)
        ...
        logging.error(f"Error starting exercise session: {str(e)}")
        raise HTTPException(status_code=500, detail=str(e))


@api_router.post("/exercises/session/update")
async def update_exercise_session(update_data: ExerciseSessionUpdate):
    """Update session progress (for AI coach real-time updates)"""
    try:
        # Find session
        session = await db.exercise_sessions.find_one(
        ...
        # Update session
        update_fields = {"completed_reps": update_data.completed_reps}
        
        if update_data.form_accuracy is not None:
            update_fields["form_accuracy"] = update_data.form_accuracy
        
        if update_data.feedback_notes:
            update_fields["feedback_notes"] = update_data.feedback_notes
        ...
        return {"message": "Session updated successfully", "completed_reps": update_data.completed_reps}
    except HTTPException:
        raise
    except Exception as e:
        logging.error(f"Error updating exercise session: {str(e)}")
        raise HTTPException(status_code=500, detail=str(e))


@api_router.post("/exercises/session/complete")
async def complete_exercise_session(complete_data: ExerciseSessionComplete):
    """Complete an exercise session and award wellness stars"""
    try:
        # Find session
        session = await db.exercise_sessions.find_one(
        ...
        # Get exercise details for calories calculation
        exercise = next((ex for ex in EXERCISE_LIBRARY if ex['id'] == session['exercise_id']), None)
        if not exercise:
            raise HTTPException(status_code=404, detail="Exercise not found")
        
        # Calculate calories burned
        calories_burned = complete_data.completed_reps * exercise['calories_per_rep']
        ...
        await db.exercise_sessions.update_one(
            ...
            {
                "$set": {
                    "completed_reps": complete_data.completed_reps,
                    "session_end": datetime.now(timezone.utc).isoformat(),
                    "duration_seconds": complete_data.duration_seconds,
                    "calories_burned": calories_burned,
                    "form_accuracy": complete_data.form_accuracy
                }
            }
        )
        
        # Award wellness stars (3 stars for completing exercise)
        stars_awarded = 3
        await db.users.update_one(
            {"user_id": session['user_id']},
            {"$inc": {"wellness_stars": stars_awarded}}
        )
        ...
        logging.error(f"Error completing exercise session: {str(e)}")
        raise HTTPException(status_code=500, detail=str(e))


@api_router.get("/exercises/history/{user_id}")
async def get_exercise_history(user_id: str, limit: int = 20):
    ...
    try:
        ...
        logging.error(f"Error fetching exercise history: {str(e)}")
        raise HTTPException(status_code=500, detail=str(e))


@api_router.get("/exercises/progress/{user_id}")
async def get_exercise_progress(user_id: str):
    """Get user's exercise progress and statistics"""
    try:
        # Get all completed sessions
        sessions = await db.exercise_sessions.find(
            {"user_id": user_id, "session_end": {"$exists": True}},
            {"_id": 0}
        ).to_list(1000)
        ...
        if not sessions:
            return {
                ...
                "average_form_accuracy": 0,
                "current_streak": 0
            }
        
        # Calculate statistics
        total_reps = sum(s.get('completed_reps', 0) for s in sessions)
        ...
        exercise_ids = list(set(s['exercise_id'] for s in sessions))
        
        # Find favorite exercise (most sessions)
        from collections import Counter
        exercise_counts = Counter(s['exercise_id'] for s in sessions)
        favorite_id = exercise_counts.most_common(1)[0][0] if exercise_counts else None
        favorite_exercise = next((ex for ex in EXERCISE_LIBRARY if ex['id'] == favorite_id), None)
        
        # Calculate average form accuracy for AI coach sessions
        ai_sessions = [s for s in sessions if s.get('used_ai_coach') and s.get('form_accuracy')]
        avg_accuracy = sum(s['form_accuracy'] for s in ai_sessions) / len(ai_sessions) if ai_sessions else 0
        
        # Calculate current streak (consecutive days with exercise)
        sessions_sorted = sorted(sessions, key=lambda x: x['session_start'], reverse=True)
        streak = 0
        last_date = None
        
        for session in sessions_sorted:
            session_date = datetime.fromisoformat(session['session_start']).date()
            if last_date is None:
                # First session
                if session_date == datetime.now(timezone.utc).date() or \
                   session_date == (datetime.now(timezone.utc) - timedelta(days=1)).date():
                    streak = 1
        ...
        return {
            ...
            "exercises_tried": len(exercise_ids),
            "favorite_exercise": favorite_exercise['name'] if favorite_exercise else None,
            "average_form_accuracy": round(avg_accuracy, 1) if avg_accuracy > 0 else None,
            "current_streak": streak,
            "recent_sessions": sessions[:5]
        }
    except Exception as e:
        logging.error(f"Error fetching exercise progress: {str(e)}")
        raise HTTPException(status_code=500, detail=str(e))
