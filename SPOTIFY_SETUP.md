...
2. Add this exact URL:
   ```
   https://crisis-alert-3.preview.emergentagent.com/music
   ```
3. Click "Add" button
...
### Common Mistakes:
- ❌ Adding trailing slash: `https://crisis-alert-3.preview.emergentagent.com/music/`
- ❌ Using http instead of https: `http://relax-player-patch.preview.emergentagent.com/music`
- ❌ Wrong path: `https://crisis-alert-3.preview.emergentagent.com/spotify`
- ✅ Correct: `https://crisis-alert-3.preview.emergentagent.com/music`
