...
2. Add this exact URL:
   ```
   https://visible-trainer-ai.preview.emergentagent.com/music
   ```
3. Click "Add" button
...
### Common Mistakes:
- ❌ Adding trailing slash: `https://visible-trainer-ai.preview.emergentagent.com/music/`
- ❌ Using http instead of https: `http://relax-player-patch.preview.emergentagent.com/music`
- ❌ Wrong path: `https://visible-trainer-ai.preview.emergentagent.com/spotify`
- ✅ Correct: `https://visible-trainer-ai.preview.emergentagent.com/music`
