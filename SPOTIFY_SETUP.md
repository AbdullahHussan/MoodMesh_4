...
2. Add this exact URL:
   ```
   https://sound-feature-cut.preview.emergentagent.com/music
   ```
3. Click "Add" button
...
### Common Mistakes:
- ❌ Adding trailing slash: `https://sound-feature-cut.preview.emergentagent.com/music/`
- ❌ Using http instead of https: `http://relax-player-patch.preview.emergentagent.com/music`
- ❌ Wrong path: `https://sound-feature-cut.preview.emergentagent.com/spotify`
- ✅ Correct: `https://sound-feature-cut.preview.emergentagent.com/music`
