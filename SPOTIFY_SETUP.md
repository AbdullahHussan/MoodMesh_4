...
2. Add this exact URL:
   ```
   https://guard-buddy.preview.emergentagent.com/music
   ```
3. Click "Add" button
...
### Common Mistakes:
- ❌ Adding trailing slash: `https://guard-buddy.preview.emergentagent.com/music/`
- ❌ Using http instead of https: `http://relax-player-patch.preview.emergentagent.com/music`
- ❌ Wrong path: `https://guard-buddy.preview.emergentagent.com/spotify`
- ✅ Correct: `https://guard-buddy.preview.emergentagent.com/music`
