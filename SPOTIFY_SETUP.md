...
2. Add this exact URL:
   ```
   https://ai-pose-fix.preview.emergentagent.com/music
   ```
3. Click "Add" button
...
### Common Mistakes:
- ❌ Adding trailing slash: `https://ai-pose-fix.preview.emergentagent.com/music/`
- ❌ Using http instead of https: `http://relax-player-patch.preview.emergentagent.com/music`
- ❌ Wrong path: `https://ai-pose-fix.preview.emergentagent.com/spotify`
- ✅ Correct: `https://ai-pose-fix.preview.emergentagent.com/music`
